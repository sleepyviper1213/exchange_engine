...
public:
	 ...
	 *        a tick of 0.01 at @p price_scale 2 is 1, at scale 8 it is
	 * 1'000'000.
	...
	[[nodiscard]] SYMBOL_EXPORT bool has_collar() const noexcept;

	/// @brief Lowest admissible price, in ticks. @c 1 when uncollared (a price
	///        of 0 ticks is never a valid order).
	[[nodiscard]] SYMBOL_EXPORT price_t collar_low() const noexcept;

	/// @brief Highest admissible price, in ticks.
	[[nodiscard]] SYMBOL_EXPORT price_t collar_high() const noexcept;

	/// @brief Is @p ticks inside the band?
	[[nodiscard]] SYMBOL_EXPORT bool
	within_collar(price_t ticks) const noexcept;
	...
	[[nodiscard]] SYMBOL_EXPORT std::size_t
	 ...
	 */
	[[nodiscard]] SYMBOL_EXPORT std::size_t
	tick_index(price_t ticks) const noexcept;

	/// @brief The inverse of @c tick_index.
	[[nodiscard]] SYMBOL_EXPORT price_t
	price_at_index(std::size_t index) const noexcept;
