...
// Reference data, and the one suite in this module that is about a
// *conformance* question rather than a decoding one: does what we read out of
...
TEST(BinanceParseExchangeInfo, TheGridIsReadOffTheVenuesOwnFilters) {
	...
	EXPECT_EQ(grid->qty_decimals, 3)
		<< "and this is the number the flags got wrong: a step of 0.001 read "
		   "at "
