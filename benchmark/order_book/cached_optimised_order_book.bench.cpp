...
// Depths: 8 fits a side in 8 cache lines, 128 is l2_book's default,
// 1024 is the "keep everything" end where the shift dominates.
...
// --------------------------------------------------------------------------
// Throughput, for the platforms without a cycle counter and as a
// cross-check that the sampled numbers above are not an artefact of the
// harness.
// --------------------------------------------------------------------------
