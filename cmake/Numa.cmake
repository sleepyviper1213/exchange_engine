...
# declared surface on EXCHANGE_WITH_NUMA, both the include directory and the
...
#
# Enable with -D EXCHANGE_WITH_NUMA=ON (see ProjectOptions.cmake).
#
...
add_library(EXCHANGE_numa INTERFACE)
add_library(exchange_engine::numa ALIAS EXCHANGE_numa)

if(NOT EXCHANGE_WITH_NUMA)
...
if(NOT CMAKE_SYSTEM_NAME STREQUAL "Linux")
    message(FATAL_ERROR
            "EXCHANGE_WITH_NUMA is Linux-only (libnuma); "
...
if(NOT NUMA_INCLUDE_DIR OR NOT NUMA_LIBRARY)
    message(FATAL_ERROR
            "EXCHANGE_WITH_NUMA=ON but libnuma was not found. "
            "Install it (Debian/Ubuntu: libnuma-dev, Fedora: numactl-devel) "
            "or configure with -DEXCHANGE_WITH_NUMA=OFF.")
endif()

target_include_directories(EXCHANGE_numa INTERFACE ${NUMA_INCLUDE_DIR})
target_link_libraries(EXCHANGE_numa INTERFACE ${NUMA_LIBRARY})
target_compile_definitions(EXCHANGE_numa INTERFACE EXCHANGE_WITH_NUMA)
