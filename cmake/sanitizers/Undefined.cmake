...
_exchange_register_sanitizer_config(UndefinedSanitizer)

if(WIN32)
    _exchange_sanitizer_uninstrumented(UndefinedSanitizer
        "Windows has no stable UBSan runtime for cl.exe/MinGW")
else()
    _exchange_add_sanitizer_flags(UndefinedSanitizer
        -fsanitize=undefined
